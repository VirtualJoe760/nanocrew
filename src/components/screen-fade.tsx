...
//   export default withScreenFade(MyScreen, { eveThrough: 'clear' }) // root Eve at FULL brightness
//
...
// `eveThrough: 'clear'` skips the scrim too — for pages that manage their own contrast (the Eve tab
// drops its scrim while the voice surface is up so she performs at full brightness).
...
export const EVE_SCRIM = 'rgba(6,8,12,0.62)';

export function withScreenFade<P extends object>(
  Screen: ComponentType<P>,
  opts?: { background?: boolean; eveThrough?: boolean | 'clear' },
) {
